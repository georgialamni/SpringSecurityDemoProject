package com.georgialamni.landon.web.application;

import com.georgialamni.controller.ReservationController;
import com.georgialamni.entity.RoomReservation;
import com.georgialamni.service.ReservationService;
...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception {
        Date date = DATE_FORMAT.parse("2020-05-13");
        ...
        this.mockMvc.perform(get("/reservation?date=2020-05-13")).andExpect(status()
